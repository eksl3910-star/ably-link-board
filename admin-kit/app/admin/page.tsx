        ...
        <div className="mt-6 rounded-xl border border-[#e7e9ee] bg-[#fbfbfd] p-4">
          <label className="mb-4 block">
            ...
            <input
              ...
              placeholder="비밀번호 입력"
              className="h-11 w-full rounded-xl border border-[#d9dde6] bg-white px-3 text-sm text-[#1f2430] outline-none ring-0 placeholder:text-[#9aa3b2] focus:border-[#0064ff]"
            />
          </label>
          ...
          <div className="flex items-center justify-between">
            ...
            <span
              className={`rounded-full px-3 py-1 text-xs font-bold ${
                isMaintenance ? "bg-[#e8f0ff] text-[#0064ff]" : "bg-[#e9fbf0] text-[#14a44d]"
              }`}
            >
          ...
          <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
            <button
              ...
              className="h-12 w-full rounded-xl bg-[#0064ff] text-base font-bold text-white disabled:cursor-not-allowed disabled:opacity-50"
            >
              서버 전체 중단
            </button>
            <button
